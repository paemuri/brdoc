...
func TestIsVoterID(t *testing.T) {
	for i, tc := range []struct {
		...
		{"InvalidFormat_ShouldReturnFalse", false, "3467875434578764345789654"},
		{"InvalidFormat_ShouldReturnFalse", false, ""},
		{"InvalidFormat_ShouldReturnFalse", false, "AAAAAAAAAAA"},
		{"InvalidFormat_ShouldReturnFalse", false, "915 5017 0193 0306"},
		{"InvalidFormat_ShouldReturnFalse", false, "174 2241 7133 0004"},
		{"InvalidFormat_ShouldReturnFalse", false, "259 7557 3388 0001"},
		{"InvalidFormat_ShouldReturnFalse", false, "808-2536-1743-0486"},
		{"InvalidFormat_ShouldReturnFalse", false, "9999 0236 0200 834"},
		{"InvalidData_ShouldReturnFalse", false, "111122223333"},
		{"InvalidData_ShouldReturnFalse", false, "098756718298"},
		{"InvalidData_ShouldReturnTrue", false, "381026662436"},
		{"InvalidData_ShouldReturnTrue", false, "148751641724"},
